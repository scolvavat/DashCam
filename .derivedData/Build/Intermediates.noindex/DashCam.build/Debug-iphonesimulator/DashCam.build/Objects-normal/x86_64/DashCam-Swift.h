...
#ifndef DASHCAM_SWIFT_H
#define DASHCAM_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DashCam",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7DashCam17DashCamController")
@interface DashCamController : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class AVCaptureOutput;
@class AVCaptureConnection;
@interface DashCamController (SWIFT_EXTENSION(DashCam)) <AVCaptureAudioDataOutputSampleBufferDelegate, AVCaptureVideoDataOutputSampleBufferDelegate>
- (void)captureOutput:(AVCaptureOutput * _Nonnull)output didOutputSampleBuffer:(CMSampleBufferRef _Nonnull)sampleBuffer fromConnection:(AVCaptureConnection * _Nonnull)connection;
@end

SWIFT_CLASS("_TtC7DashCam25DashConvoyPresenceService")
@interface DashConvoyPresenceService : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@class NSString;
@class NSData;
@interface DashConvoyPresenceService (SWIFT_EXTENSION(DashCam)) <NSURLSessionWebSocketDelegate>
- (void)URLSession:(NSURLSession * _Nonnull)session webSocketTask:(NSURLSessionWebSocketTask * _Nonnull)webSocketTask didOpenWithProtocol:(NSString * _Nullable)selectedProtocol;
...
@class CLLocation;
@class CLHeading;
SWIFT_CLASS("_TtC7DashCam19DashLocationManager")
@interface DashLocationManager : NSObject <CLLocationManagerDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC7DashCam19DashNavigationModel")
@interface DashNavigationModel : NSObject <MKLocalSearchCompleterDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
@class NSCoder;
SWIFT_CLASS("_TtC7DashCam11PreviewView")
